...
name: Stacks
group: Layout
description: Stack is a flexbox reset; XStack and YStack pin the direction, ZStack layers its children, and ThemeableStack adds the theme-reactive variants everything else extends.
---
...
Every stack takes the full style prop surface (see the [style system guide](../style-system.md))
